    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0F172A] p-4">
      <div className="w-full max-w-md glass-card p-8 rounded-2xl border border-slate-800 shadow-2xl">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-extrabold text-white tracking-tight">RetailMind AI</h2>
          <p className="text-xs text-slate-400">Sign in to your Hyperlocal Demand Platform</p>
        </div>
